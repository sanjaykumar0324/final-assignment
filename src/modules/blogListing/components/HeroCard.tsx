        ...
        <div className="lg:col-span-1 flex flex-col gap-4 ">
          <div className="bg-[#BDE48A]    justify-center p-4 xl:px-10 h-[30vh] md:h-[40] lg:h-[30]   rounded-xl">
             <div className="flex justify-end ">
                 <p className="text-2xl text-end p-2 border border-black rounded-full ">{<BLOG_SPARK_ICON/>}</p>
             </div>
            <div className="flex flex-col h-[100%] justify-center gap-4">
                <p className="font-bold">Design</p>
                <p>{BLOG_HERO_DESIGN}</p>
                <p className="flex items-center gap-2 underline hover:text-red-400">Read More <NAVIGATE_ARROW_ICON/></p>
            </div>
          </div>
          <div className="h-[40vh] lg:h-[58vh] bg-red-600 rounded-2xl ">
