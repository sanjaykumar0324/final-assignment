...
import { CUSTOMER_CARE_DESC, CUSTOMER_CARE_TITLE } from "../../../utils/constants";
    ...
    <div className="my-20">
      <div className="container mx-auto">
        <div className=" flex flex-col items-center gap-10 mb-10 px-2">
          <h1 className="text-2xl lg:text-4xl font-bold">{CUSTOMER_CARE_TITLE}</h1>
          <p>{CUSTOMER_CARE_DESC}</p>
        </div>
